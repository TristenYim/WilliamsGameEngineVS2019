...
GameScene::GameScene() {
	std::vector<Gun> shipGuns = { Gun(10, 2.0f, -0.25), Gun(10, 2.0f, 0.0), Gun(10, 2.0f, 0.25), Gun(10, 2.0f, 0.5), Gun(10, 2.0f, 0.75), Gun(10, 2.0f, 1.0), Gun(10, 2.0f, 1.25), };
//	std::vector<Gun> shipGuns = { Gun(500, 1.0f, 0.25), Gun(300, 2.0f, 0.5), Gun(500, 1.0f, 0.75) };
	...
	ShipPtr ship_3 = std::make_shared<Ship>(sf::Vector2f{ 192, 580 }, shipGuns, true, false);
	addGameObject(ship_3);
